...
class VOCDataset(Dataset):
    ...
    def __init__(self, split, size, data_dir='/home/ubuntu/hw1-main/q1_q2_classification/data/VOCdevkit/VOC2007/'):
        super().__init__()
        self.split = split
    ...
    def get_random_augmentations(self, train=True):
        ######################################################################
        ...
        if train:
            augmentation = [
                transforms.RandomResizedCrop(self.size),  # Resized crop with scale
                #transforms.RandomRotation(60),      
                transforms.RandomHorizontalFlip(p=0.1),  
                transforms.RandomVerticalFlip(p=0.1) 
            ]
        else:
            # For validation or test, use center crop or just resize
            augmentation = [
    ...
    def __getitem__(self, index):
        ...
        trans = transforms.Compose([
            ...
            *self.get_random_augmentations(train=self.split == 'trainval'),
            transforms.ToTensor(),
